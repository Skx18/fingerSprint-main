...
public class fingerPrintController {
    ...
    public List<FingerprintVerificationRequest.UserFingerprint> getStoredFingerprintsFromFlask() {
        String flaskUrl = "https://bomberos-flask.onrender.com/attendance/fingerPrint"; // Asegúrate de que Flask esté corriendo en este puerto
        RestTemplate restTemplate = new RestTemplate();
    ...
    public ResponseEntity<Map<String, Object>> verifyFingerprint() {
        try {
            ...
            RestTemplate restTemplate = new RestTemplate();
            ResponseEntity<UserFingerprint[]> response = restTemplate.getForEntity("https://bomberos-flask.onrender.com/attendance/fingerprints", UserFingerprint[].class);
